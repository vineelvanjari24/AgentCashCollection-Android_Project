...
public class RecoveryReceiptActivity extends AppCompatActivity {

    Button newCollection, print;
    TextView agentName, receiptNo, receiptDate, receiptTime, accHolder, accNumber, prevBalance, dedAmount, curBalance, accOpenDate, lastBill, lastPaid, cusPhoneNumber, address;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recovery_receipt);
        ...
        dedAmount = findViewById(R.id.dedAmount);
        curBalance = findViewById(R.id.curBal);
        accOpenDate = findViewById(R.id.accOpenDt);
        ...
        String agentNameText, receiptDateText, receiptTimeText, receiptNoText, accHolderText, accNoText, oldBalText, dedAmountText, newBalText, accOpenDateText, lastBillText, lastPaidText, cusPhoneNumberText, addressText;
        ...
        dedAmountText = bundleDetails.getString("Ded Amount");
        newBalText = bundleDetails.getString("New Balance");
        accOpenDateText = bundleDetails.getString("Acc Open Date");
        ...
        dedAmount.setText(dedAmountText);
        curBalance.setText(newBalText);
        accOpenDate.setText(accOpenDateText);
            ...
            public void onClick(View v) {
                ...
                if (flag) {
                    ...
                    try {
                        ...
                        byte[] arrLastBill = ("Last Bill Date : "+lastBillText+"\n\n").getBytes("GB2312");
                        byte[] arrLastPaid = ("Last Paid Amt  : "+lastPaidText+"\n\n").getBytes("GB2312");
                        byte[] arrRefNo = ("Ref No.        : HFEIFHOEHFYRYFT\n\n").getBytes("GB2312");
                        byte[] arrOpeningBal = ("Opening Balance: "+oldBalText+"\n\n").getBytes("GB2312");
                        byte[] arrDedAmount = ("Deduct Amount  : "+dedAmountText+"\n\n").getBytes("GB2312");
                        byte[] curBalance = ("Cur.  Balance  : "+newBalText+"\n\n").getBytes("GB2312");
                        byte[] accOpenDate = ("Acc. Open Date : "+accOpenDateText+"\n\n").getBytes("GB2312");
                        ...
                        PrinterInterface.write(arrStar, arrStar.length);
                        PrinterInterface.write(accOpenDate, accOpenDate.length);
                        ...
                        PrinterInterface.write(arrDedAmount, arrDedAmount.length);
